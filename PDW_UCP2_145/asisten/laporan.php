...
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="flex flex-col md:flex-row justify-between items-center mb-4 gap-4">
        ...
        <form action="laporan.php" method="GET" class="flex items-center gap-2 flex-wrap">
            <input type="text" name="mahasiswa" placeholder="Cari mahasiswa..." class="shadow-sm appearance-none border border-gray-300 rounded-md py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?php echo htmlspecialchars($filter_mahasiswa); ?>">
            <select name="praktikum_id" class="shadow-sm appearance-none border border-gray-300 rounded-md py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500" onchange="this.form.submit()">
            ...
            <select name="modul_id" class="shadow-sm appearance-none border border-gray-300 rounded-md py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500" <?php echo !$modul_options ? 'disabled' : ''; ?>>
            ...
            <select name="status" class="shadow-sm appearance-none border border-gray-300 rounded-md py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <button type="submit" class="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-md transition-colors">Filter</button>
        </form>
    </div>
                        ...
                        <tr class="hover:bg-gray-50">
                            <td class="py-4 px-6 whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="flex-shrink-0 h-10 w-10 rounded-full bg-gray-200 flex items-center justify-center"><span class="font-bold text-gray-600"><?php echo getInitials($row['nama_mahasiswa']); ?></span></div>
                            ...
                            <td class="py-4 px-6 whitespace-nowrap text-center text-sm font-medium">
                                <button onclick='openGradeModal(<?php echo json_encode($row, JSON_HEX_APOS); ?>)' class="text-blue-600 hover:text-blue-800 transition-colors" title="Beri Nilai">
                                    <svg class="inline w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L6.832 19.82a4.5 4.5 0 01-1.897 1.13l-2.685.8.8-2.685a4.5 4.5 0 011.13-1.897L16.863 4.487zm0 0L19.5 7.125" /></svg>
                                    <span class="sr-only">Beri Nilai</span>
                                </button>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <div class="mt-4 space-y-4">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">File: <a id="grade-file-link" href="#" class="text-blue-500 hover:underline" download>Unduh Laporan</a></p>
                        </div>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-start">
                            <div class="md:col-span-1"><label for="grade-nilai" class="block text-sm font-medium text-gray-700">Nilai (0-100)</label><input type="number" step="0.01" min="0" max="100" id="grade-nilai" name="nilai" class="mt-1 shadow-sm appearance-none border border-gray-300 rounded-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500" required></div>
                            <div class="md:col-span-2"><label for="grade-feedback" class="block text-sm font-medium text-gray-700">Feedback (Opsional)</label><textarea id="grade-feedback" name="feedback" rows="3" class="mt-1 shadow-sm appearance-none border border-gray-300 rounded-md w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea></div>
                        </div>
                    </div>
                </div>
...
function openGradeModal(data) {
    ...
    // [PERBAIKAN] Menggunakan path yang benar untuk download
